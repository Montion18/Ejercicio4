...
if __name__ == '__main__':
    ...
    r = FechaHora (1,1,2020,0,0,0) #  inicilizar día, mes, año con 1/1/2020, y hora, minutos y 
    
                              #  segundos con 0h, 0m, 0s.

    r1 = FechaHora(d,mes,a,0,0,0); # inicializar con 0h 0m 0s
